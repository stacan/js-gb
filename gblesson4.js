...
//2.Максимально близкая к идеальной реализации 
// корзина getCartFullPrice;
//3.
//4.
//5.
//6.
...
// должна как то изменяться (те из нее не должно что
...
//Обьекты - это всетаки какие то сущности, они где то
